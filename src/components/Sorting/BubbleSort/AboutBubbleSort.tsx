...
const AboutBubbleSort = () => {
  ...
  return (
    ...
    <section className="relative flex h-[85vh] flex-col items-center justify-around overflow-hidden text-white">
      ...
      Bubble sort is a simple sorting algorithm that repeatedly steps through the list, compares adjacent elements, and swaps them if they are in the wrong order. This process continues until the list is sorted. It's called "bubble sort" because smaller elements "bubble" to the top of the list. While easy to understand and implement, bubble sort is inefficient for large lists due to its average and worst-case time complexity of O(n²).
      </p>
